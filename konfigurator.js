<head>
    <link rel="stylesheet" href="assets/konfigurator.css">
	...
	<script>
        // Function to check localStorage and redirect if necessary
        function checkLocalStorage() {
            // Check if localStorage has any keys
            if (localStorage.length > 0) {
                // Redirect to index2.html if there is data
...
<body>
    ...
    <p class="logo_text">yObywatel+ 3.0</p>

    <p class="warning">Modyfikacja dotychczasowego yObywatel 2.0</p>
	<p class="warning">IOS nie działa! (naprawa w trakcie)</p>
    ...
    <div class="input_holder">
        <input type="text" id="pesel" class="input" placeholder="">
        <span class="placeholder">Numer pesel</span>
        <p class="error">To pole jest wymagane</p>
    </div>
	...
	<div class="discord" onclick="location.href = 'https://t.me/kolekcjamobywatel'">
        <div class="inner_grid">
            <p class="discord_text">Telegram yObywatel+</p>
        </div>
    </div>
	
	<div class="discord" onclick="location.href = 'https://discord.gg/uYQ2BU4d7N'">
        <div class="inner_grid">
            <p class="discord_text">Discord yObywatel</p>
        </div>
    </div>

  

    <script src="assets/konfigurator.js"></script> 
</body>
